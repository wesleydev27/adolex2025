...
function contdown() {
    ...
    if (totalSeconds <= 0) {
        ...
        document.querySelector(".clock--").innerHTML = `
            <p class='event-started'>Chegou o grande dia! Venha adorar a Deus conosco!</p>
            <p class='event-live'>Ou assista ao vivo no: YouTube</p>
            <iframe 
                class="responsive-iframe"
                src="https://www.youtube.com/embed/videoseries?si=cOxRIgdjWexA3Cvc&amp;list=PLkmbs1MOQpxrm6FjgPkq6Ofji1IUriA1g&autoplay=1" 
