...
function contdown() {
    ...
    if (totalSeconds <= 0) {
        ...
        document.querySelector(".clock--").innerHTML = `
            <p class='event-started'>2° dia do nosso Congresso de Adolescentes!</p>
            <p class='event-live'>Venha adorar a Deus conosco ou assista ao vivo no YouTube</p>
            <iframe 
                class="responsive-iframe"
                src="https://www.youtube.com/embed/9C5JA4rSfms?si=oEI_b7ViyZewtDR1;list=PLkmbs1MOQpxrm6FjgPkq6Ofji1IUriA1g&autoplay=1" 
